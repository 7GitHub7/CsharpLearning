...
namespace Gifter.Integration.Tests.Common.Builders
{
    public class CategoryBuilder
    {
        private CategoryId categoryId = new CategoryId(999);

        private CategoryUniqueId categoryUniqueId = new CategoryUniqueId(Guid.NewGuid());
